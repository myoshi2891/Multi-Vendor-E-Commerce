...
- Raw audit findings: [`audit/findings-01〜08-*.md`](audit/) (Round 1) / [`audit/findings-09-direction-expansion.md`](audit/findings-09-direction-expansion.md) (Round 2)
...
- **Expansion blueprint (Round 2 中心成果物)**: [`direction/EXPANSION_BLUEPRINT.md`](direction/EXPANSION_BLUEPRINT.md)
- Session resume state: [`ADVISOR_STATE.md`](ADVISOR_STATE.md)

> **Note (Round 2)**: plans 013–017 および Round 2 の成果物は**日本語のみ**で執筆されている

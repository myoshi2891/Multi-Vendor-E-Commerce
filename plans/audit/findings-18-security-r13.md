...
| 項目 | 監査時点（`7080b12`） | その後 |
|---|---|---|
| `next` | `16.2.1` に解決・HIGH クラスタの影響下 | **2026-07-18: plan 057 実行で `~16.2.10` へ bump（DONE）** → **2026-07-30: 新規 9 advisory（HIGH 4 / MODERATE 5、影響範囲 `<16.2.11`）で再露出し `~16.2.12` へ bump**（`findings-06-dependencies.md` DEPS-08 解決②） |

                        ...
                        <table className="min-w-full text-sm">
                            <tbody>
                                ...
                                <tr className="border-b  border-gray-100 dark:border-gray-100/20">
                                    ...
                                    <td className="p-3">
                                        <p>
                                            ${store.defaultShippingFeePerItem.toNumber().toFixed(2)}
                                        </p>
                                    </td>
                                </tr>
                                <tr className="border-b border-gray-100 dark:border-gray-100/20">
                                    ...
                                    <td className="p-3">
                                        <p>
                                            $
                                            {
                                                store.defaultShippingFeeForAdditionalItem.toNumber().toFixed(2)
                                            }
                                        </p>
                                    </td>
                                </tr>
                                <tr className="border-b border-gray-100 dark:border-gray-100/20">
                                    ...
                                    <td className="p-3">
                                        <p>${store.defaultShippingFeePerKg.toNumber().toFixed(2)}</p>
                                    </td>
                                </tr>
                                <tr className="border-b border-gray-100 dark:border-gray-100/20">
                                    <td className="p-3">
                                    ...
                                    <td className="p-3">
                                        <p>${store.defaultShippingFeeFixed.toNumber().toFixed(2)}</p>
                                    </td>
                                </tr>
                                <tr className="border-b border-gray-100 dark:border-gray-100/20">
                                    <td className="p-3">

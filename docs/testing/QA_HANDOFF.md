...
| 指標 | 値 |
|------|-----|
| Jest テスト総数 | **1088** / 99 スイート（97 passed + 2 skipped）— 2026-05-28 に B1+ Sprint 3（Tier 2 全 8 プリミティブ snapshot）追加で +19 |
| Jest スナップショット | **112**（`tests/component/ui/__snapshots__/`）— B1+ Sprint 3 で +19（dropdown-menu / context-menu / menubar / sheet / drawer / tabs / toggle-group / table） |
...
**B1+ Sprint 3（Tier 2 全 8 プリミティブ）** は 2026-05-28 に完了（`e6c79e3`〜`4429b8b`、テスト総数 1069 → 1088 / +19、snapshot 93 → 112 / +19）。残り 11 プリミティブ（Tier 3 + 補助）は Sprint 4 で継続。
...
- **B1+** Sprint 1 完了（2026-05-26、Tier 1 前半 10 プリミティブ / +26 snapshot）。Sprint 2 完了（2026-05-28、Tier 1 後半 11 プリミティブ / +27 snapshot）。Sprint 3 完了（2026-05-28、Tier 2 全 8 プリミティブ / +19 snapshot）。残り 11 プリミティブ（Tier 3 + 補助）は Sprint 4（後続 PR）

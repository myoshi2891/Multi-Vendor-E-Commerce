...
| Playwright a11y | **4 スペック**（sign-in / seller-apply / checkout / profile）・**4 spec すべて passed**。2026-08-03 実測（`bunx playwright test tests/e2e/a11y --project=chromium`）。増減の経緯・実測履歴は [`COVERAGE_REPORT.md §7 履歴`](./COVERAGE_REPORT.md#7-履歴) |
| 型エラー | **0 件** |

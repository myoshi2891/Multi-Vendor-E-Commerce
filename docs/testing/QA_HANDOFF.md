...
| 指標 | 値 |
|------|-----|
| Jest テスト総数 | **1103** / 110 スイート（108 passed + 2 skipped）— 2026-05-28 に B1+ Sprint 4（Tier 3 + 補助 全 11 プリミティブ snapshot）追加で +15、**B1+ 完了 (49/49 shadcn/ui プリミティブカバー)** |

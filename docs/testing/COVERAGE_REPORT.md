...
| テスト総数 | **1398 unit/component passed** (3 skipped) + **17 integration** — 2026-06-16 時点（Phase 5-B platform-wide クーポン完了: placeOrder/applyCoupon/updateCheckoutProductWithLatest の PLATFORM scope 対応、AdminCouponFormSchema superRefine、upsertCouponAsAdmin・seller upsertCoupon の P2002 統一日本語メッセージ：1387→1398 / 143 スイート不変）。残 3 skip は DB ゲートの idempotency suite |

...
| テスト総数 | **1348 unit/component passed** (3 skipped) + **17 integration** — 2026-06-15 時点（Phase 3 F3-第1段：isActive 再検証 + admin クーポン query 4 種 +20：1328→1348 / 141 スイート）。残 3 skip は DB ゲートの idempotency suite |

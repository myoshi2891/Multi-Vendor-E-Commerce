...
| テスト総数 | **1451 unit/component passed** (3 skipped) + **17 integration** — 2026-06-18 時点（販売者ダッシュボード Phase 2-C 完了: 全 6 コンポーネントがテスト完備、`inventory-alert-summary.test.tsx` +3、1443→1451、147→150 スイート）。残 3 skip は DB ゲートの idempotency suite |

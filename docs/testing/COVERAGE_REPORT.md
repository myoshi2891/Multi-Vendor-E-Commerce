...
| テスト総数 | **1387 unit/component passed** (3 skipped) + **17 integration** — 2026-06-16 時点（SonarCloud QG 修復（PR #138）: CouponFormFields 抽出 / coupon.ts 残ブランチカバー / columns.tsx テスト / admin-coupon-details.tsx 10 件：1348→1387 / 143 スイート）。残 3 skip は DB ゲートの idempotency suite |
